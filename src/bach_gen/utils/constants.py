...
# Default era/style filter for `bach-gen prepare-data`.
DEFAULT_PREPARE_COMPOSER_FILTER = ["bach", "baroque", "renaissance", "classical"]


# Map directory name (from corpus roots under data/midi/) to style/era name.
# Values should generally be one of the tokenizer-supported styles
# ("bach", "baroque", "renaissance", "classical"). Extra eras such as
# "romantic"/"modern" are used only for filtering and are excluded by default.
DIR_TO_STYLE: dict[str, str] = {
    ...
    # Renaissance / late-medieval vocal polyphony
    ...
    "gabrieli-g": "renaissance",
    "gesualdo": "renaissance",
    "giovannelli": "renaissance",
    "guerrero": "renaissance",
    "hassler": "renaissance",
    "holborne": "renaissance",
    "isaac": "renaissance",
    "josquin": "renaissance",
    "lasso": "renaissance",
    "lassus": "renaissance",
    ...
    # Classical (+ explicit project choice: include Mendelssohn)
    ...
    # Non-default eras (excluded by default filter)
    "adam": "romantic",
    "andree": "romantic",
    "alkan": "romantic",
    "beach": "romantic",
    ...
    "smyth": "romantic",
    "schumann": "romantic",
    "schumann_robert": "romantic",
    "schumann_clara": "romantic",
    "stanford": "romantic",
    "strauss": "romantic",
    "wolf": "romantic",
    "bartok": "modern",
